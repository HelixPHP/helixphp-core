 ...
 *
 * Demonstra como criar e usar extensões/plugins no Express-PHP v2.1.0
...
echo "🚀 Express-PHP Extension System Demo\n";
echo "=====================================\n\n";
...
$app->addFilter('response.headers', function ($headers, $context) {
    ...
    $headers['X-Powered-By'] = 'Express-PHP-Extended';
...
$app->get('/', function ($req, $res) use ($app) {
    ...
    // Aplicar filtros
    $responseData = [
        'message' => 'Express-PHP Extension System',
        'status' => 'active',
        'features' => [
            'auto_discovery' => true,
            'hook_system' => true,
...
echo "\n\n✅ Sistema de extensões Express-PHP demonstrado com sucesso!\n";
