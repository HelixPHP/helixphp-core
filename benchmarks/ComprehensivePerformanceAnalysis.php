...
class ComprehensivePerformanceAnalysis
{
    ...
    private function benchmarkExpressCore(): void
    {
        ...
        // require_once __DIR__ . '/../src/ApiPivot.php';
    ...
    private function generateMarkdownReport(): void
    {
        ...
        $md .= "This report provides a comprehensive analysis of the PivotPHP framework performance across three major phases:\n\n";
        ...
        $md .= "---\n";
        $md .= "*Report generated by PivotPHP Framework Performance Analysis Tool*\n";
